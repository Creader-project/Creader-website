...
export default {
  ...
  methods: {
    getCategory() {
      axios.get('http://127.0.0.1:8000/api/v1/all-category').then((response) => {
    ...
    getAuthorBook() {
      ...
      axios.get(`http://127.0.0.1:8000/api/v1/author/book/${this.bookId}`).then((response) => {
        console.log(response.data);
    ...
    updateAuthorBook() {
      axios.all(
          [axios.patch(`http://127.0.0.1:8000/api/v1/author/book/${this.bookId}`, this.formData, {
            headers: {
              'Content-type': 'multipart/form-data',
            }
          }),
            axios.patch(`http://127.0.0.1:8000/api/v1/author/book/${this.bookId}`, {
    ...
    deleteAuthorBook() {
      axios.delete(`http://127.0.0.1:8000/api/v1/author/book/${this.bookId}/`).then((response) => {
        this.$message({
